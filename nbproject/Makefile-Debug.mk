...
LDLIBSOPTIONS=-lQt5Cored -lQt5Guid -lQt5Widgetsd /C/Programs/Box2D/lib/libliquidfun.dll.a
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/6Box2DTestbed.exe
